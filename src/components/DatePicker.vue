...
input, button, select {margin: 0; padding:0; *font-size: 100%;}
...
body, button, input, select, textarea {font: 12px/1.5 "arial","Microsoft YaHei"; color:#333 }
...
.fl{float: left;}
.fr{float: right;}
.color-red{color:#e24242;}
.color-green{color:#00af8d;}
.hide{display: none;}
