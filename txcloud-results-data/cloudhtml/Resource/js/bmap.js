...
Array.prototype.get = function (name) {
    var map;
    this.forEach(function (bMap) {
        if (map != null) {
            return;
        }
        if (bMap.hasOwnProperty("type") && bMap.type == "bMap") {
            if (bMap.hasOwnProperty("name") && bMap.name == name) {
                map = bMap.hasOwnProperty("map") ? bMap.map : null;
            }
        } else {
            map = null;
        }
            ...
            var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
                ...
                BMapCoordSys.create = function (ecModel, api) {
                    ...
                    ecModel.eachComponent('bmap', function (bmapModel) {
                        ...
                        var isExists = false;
                        var isExistsCopy = false;
                        BMapArr.forEach(function (o) {
                            if (!isExists && o.name == root.id) {
                                isExists = true;
                            }
                        });
                        if (!isExists) {
